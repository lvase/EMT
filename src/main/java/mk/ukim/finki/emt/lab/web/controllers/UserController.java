...
@Tag(name="User API", description = "register and authentication")
public class UserController {

    private final UserAppService userApplicationService;

    public UserController(UserAppService userApplicationService) {
